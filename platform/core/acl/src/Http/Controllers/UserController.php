...
namespace Guestcms\ACL\Http\Controllers;

use Guestcms\ACL\Forms\PasswordForm;
use Guestcms\ACL\Forms\PreferenceForm;
use Guestcms\ACL\Forms\ProfileForm;
use Guestcms\ACL\Forms\UserForm;
use Guestcms\ACL\Http\Requests\AvatarRequest;
use Guestcms\ACL\Http\Requests\CreateUserRequest;
use Guestcms\ACL\Http\Requests\PreferencePatchRequest;
...
use Guestcms\ACL\Services\ChangePasswordService;
use Guestcms\ACL\Services\CreateUserService;
use Guestcms\ACL\Tables\UserTable;
