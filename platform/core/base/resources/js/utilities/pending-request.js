...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => Guestcms.showButtonLoading(element))
        this.completed(() => Guestcms.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => Guestcms.showLoading(element))
        this.completed(() => Guestcms.hideLoading(element))
    ...
    withDefaultErrorHandler() {
        this.errorHandlerUsing((error) => {
            ...
            switch (statusCode) {
                case 419:
                    Guestcms.showError('Session expired this page will reload in 5s.')
