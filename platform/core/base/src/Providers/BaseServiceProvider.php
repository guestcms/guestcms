...
use Guestcms\Base\Exceptions\Handler;
...
use Guestcms\Base\Facades\PanelSectionManager as PanelSectionManagerFacade;
use Guestcms\Base\GlobalSearch\GlobalSearchableManager;
use Guestcms\Base\Models\BaseModel;
use Guestcms\Base\PanelSections\Manager as PanelSectionManager;
...
use Guestcms\Base\Supports\Action;
use Guestcms\Base\Supports\Breadcrumb;
use Guestcms\Base\Supports\CustomResourceRegistrar;
use Guestcms\Base\Supports\DashboardMenuItem;
use Guestcms\Base\Supports\Database\Blueprint;
use Guestcms\Base\Supports\Filter;
use Guestcms\Base\Supports\GoogleFonts;
...
use Guestcms\Base\Widgets\Contracts\AdminWidget as AdminWidgetContract;
use Guestcms\Setting\Providers\SettingServiceProvider;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        config()->set(['session.cookie' => Str::slug(config('core.base.general.session_cookie', 'guestcms_session'), '_')]);
