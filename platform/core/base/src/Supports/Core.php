...
use Guestcms\Base\Events\LicenseActivated;
use Guestcms\Base\Events\LicenseActivating;
use Guestcms\Base\Events\LicenseDeactivated;
use Guestcms\Base\Events\LicenseDeactivating;
use Guestcms\Base\Events\LicenseInvalid;
use Guestcms\Base\Events\LicenseRevoked;
use Guestcms\Base\Events\LicenseRevoking;
use Guestcms\Base\Events\LicenseUnverified;
use Guestcms\Base\Events\LicenseVerified;
use Guestcms\Base\Events\LicenseVerifying;
use Guestcms\Base\Events\SystemUpdateAvailable;
use Guestcms\Base\Events\SystemUpdateCachesCleared;
use Guestcms\Base\Events\SystemUpdateCachesClearing;
use Guestcms\Base\Events\SystemUpdateChecked;
use Guestcms\Base\Events\SystemUpdateChecking;
use Guestcms\Base\Events\SystemUpdateDBMigrated;
use Guestcms\Base\Events\SystemUpdateDBMigrating;
use Guestcms\Base\Events\SystemUpdateDownloaded;
use Guestcms\Base\Events\SystemUpdateDownloading;
use Guestcms\Base\Events\SystemUpdateExtractedFiles;
use Guestcms\Base\Events\SystemUpdatePublished;
use Guestcms\Base\Events\SystemUpdatePublishing;
use Guestcms\Base\Events\SystemUpdateUnavailable;
use Guestcms\Base\Exceptions\CouldNotConnectToLicenseServerException;
use Guestcms\Base\Exceptions\LicenseInvalidException;
use Guestcms\Base\Exceptions\LicenseIsAlreadyActivatedException;
use Guestcms\Base\Exceptions\MissingCURLExtensionException;
use Guestcms\Base\Exceptions\MissingZipExtensionException;
use Guestcms\Base\Exceptions\RequiresLicenseActivatedException;
...
final class Core
{
    ...
    private string $licenseUrl = 'https://license.guestcms.com';
    ...
    /**
     * @throws \Guestcms\Base\Exceptions\LicenseInvalidException
     * @throws \Guestcms\Base\Exceptions\LicenseIsAlreadyActivatedException
     */
    ...
    private function parseDataFromCoreDataFile(): void
    {
        ...
        $this->productSource = Arr::get($data, 'source', 'Coastal Media Brand');
