    ...
    handleModals() {
        ...
        _self.$body
            ...
            .on('click', '#modal-properties button[type="submit"]', (event) => {
                ...
                Guestcms.showButtonLoading($modal.find('button[type="submit"]'))
                ...
                ActionsService.processAction(
                    ...
                    () => {
                        $modal.modal('hide')
                        Guestcms.hideButtonLoading($modal.find('button[type="submit"]'))
        ...
        _self.$body
            ...
            .on('submit', '#modal_crop_image .form-crop', (event) => {
                ...
                Guestcms.showButtonLoading($form.find('button[type="submit"]'))
                ...
                ActionsService.processAction(
                    ...
                    (response) => {
                        ...
                        Guestcms.hideButtonLoading($form.find('button[type="submit"]'))
                    }
                )
            })
