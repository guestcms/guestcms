;(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.excel',
                GuestcmsVariables.languages.tables.excel ? GuestcmsVariables.languages.tables.excel : 'Excel'
            )}`
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.export',
                GuestcmsVariables.languages.tables.export ? GuestcmsVariables.languages.tables.export : 'Export'
            )}`
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.csv',
                GuestcmsVariables.languages.tables.csv ? GuestcmsVariables.languages.tables.csv : 'CSV'
            )}`
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return `<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                ${dt.i18n(
                    'buttons.print',
                    GuestcmsVariables.languages.tables.print ? GuestcmsVariables.languages.tables.print : 'Print'
                )}`
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return `<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                ${dt.i18n(
                    'buttons.reset',
                    GuestcmsVariables.languages.tables.reset ? GuestcmsVariables.languages.tables.reset : 'Reset'
                )}`
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return `
                ...
                ${dt.i18n(
                    'buttons.reload',
                    GuestcmsVariables.languages.tables.reload ? GuestcmsVariables.languages.tables.reload : 'Reload'
                )}`
        },
        ...
        init() {
            ...
            if ($.fn.dataTable) {
                ...
                $(document).on('error.dt', (e, settings, techNote, message) => {
                    Guestcms.handleDatatableError({ responseJSON: { message } });
                });
            }
        ...
        handleActionsRow() {
            ...
            $('.delete-crud-entry').on('click', (event) => {
                ...
                $httpClient
                    ...
                    .catch((error) => {
                        Guestcms.handleDatatableError(error)
            ...
            $(document).on('click', '.delete-many-entry-trigger', (event) => {
                ...
                if (ids.length === 0) {
                    Guestcms.showError(
                        GuestcmsVariables.languages.tables.please_select_record
                            ? GuestcmsVariables.languages.tables.please_select_record
