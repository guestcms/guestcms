...
use Guestcms\Table\Abstracts\Concerns\DeprecatedFunctions;
use Guestcms\Table\Abstracts\Concerns\HasActions;
use Guestcms\Table\Abstracts\Concerns\HasBulkActions;
use Guestcms\Table\Abstracts\Concerns\HasColumnVisibility;
use Guestcms\Table\Abstracts\Concerns\HasFilters;
use Guestcms\Table\Abstracts\Concerns\HasHeaderActions;
use Guestcms\Table\Columns\CheckboxColumn;
use Guestcms\Table\Columns\Column;
use Guestcms\Table\Columns\RowActionsColumn;
use Guestcms\Table\Contracts\FormattedColumn;
use Guestcms\Table\HeaderActions\HeaderAction;
use Guestcms\Table\Supports\Builder as CustomTableBuilder;
use Guestcms\Table\Supports\TableExportHandler;
use Closure;
...
abstract class TableAbstract extends DataTable implements ExtensibleContract
{
    ...
    /**
     * @var \Guestcms\Table\Columns\Column[]
     */
    ...
    /**
     * @param  \Guestcms\Table\Columns\Column[]  $columns
     */
