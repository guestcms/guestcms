...
namespace Guestcms\SeoHelper\Entities\Twitter;
...
use Guestcms\SeoHelper\Contracts\Entities\TwitterCardContract;
use Guestcms\SeoHelper\Exceptions\InvalidTwitterCardException;
