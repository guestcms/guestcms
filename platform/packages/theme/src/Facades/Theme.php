...
use Guestcms\Theme\Theme as BaseTheme;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \Guestcms\Theme\Theme layout(string $layout)
 * @method static \Guestcms\Theme\Theme uses(string|null $theme = null)
 * @method static \Guestcms\Theme\Theme theme(string|null $theme = null)
 ...
 * @method static \Guestcms\Theme\Theme setThemeName(string $theme)
 * @method static string getPublicThemeName()
 * @method static void fire(string $event, callable|object|array|string|null $args)
 * @method static \Guestcms\Theme\Breadcrumb breadcrumb()
 * @method static \Guestcms\Theme\Theme append(string $region, string $value)
 * @method static \Guestcms\Theme\Theme set(string $region, mixed|null $value)
 * @method static \Guestcms\Theme\Theme prepend(string $region, string $value)
 ...
 * @method static \Guestcms\Theme\Asset|\Guestcms\Theme\AssetContainer asset()
 * @method static \Guestcms\Theme\Theme ofWithLayout(string $view, array $args = [])
 * @method static \Guestcms\Theme\Theme of(string $view, array $args = [])
 * @method static mixed scope(string $view, array $args = [], $default = null)
 * @method static \Guestcms\Theme\Theme setUpContent(string $view, array $args = [])
 * @method static \Guestcms\Theme\Theme load(string $view, array $args = [])
 ...
 * @method static \Guestcms\Theme\Theme fireEventGlobalAssets()
