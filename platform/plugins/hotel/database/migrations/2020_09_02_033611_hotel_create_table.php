...
return new class () extends Migration {
    ...
    {
        Schema::create('ht_currencies', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('ht_rooms', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('ht_amenities', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('ht_rooms_amenities', function (Blueprint $table): void {
        ...
        Schema::create('ht_foods', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->text('description')->nullable();
            $table->decimal('price', 15, 0)->nullable()->unsigned();
        ...
        Schema::create('ht_food_types', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->string('icon', 120)->nullable();
            $table->string('status', 60)->default('published');
        ...
        Schema::create('ht_bookings', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('ht_booking_addresses', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('ht_booking_rooms', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('booking_id');
        ...
        Schema::create('ht_booking_services', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('booking_id');
            $table->foreignId('service_id');
        });

        Schema::create('ht_room_dates', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('room_id')->nullable();
        ...
        Schema::create('ht_customers', function (Blueprint $table): void {
            $table->id();
            $table->string('first_name', 60);
            $table->string('last_name', 60);
        ...
        Schema::create('ht_room_categories', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->string('status', 60)->default('published');
            $table->timestamps();
        ...
        Schema::create('ht_features', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->text('description')->nullable();
            $table->string('icon', 120)->nullable();
        ...
        Schema::create('ht_services', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->text('description')->nullable();
            $table->longText('content')->nullable();
        ...
        Schema::create('ht_places', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
        ...
        Schema::create('ht_taxes', function (Blueprint $table): void {
            $table->id();
