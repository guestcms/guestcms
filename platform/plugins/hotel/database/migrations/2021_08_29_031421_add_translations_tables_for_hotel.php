...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('ht_rooms_translations', function (Blueprint $table): void {
        ...
        Schema::create('ht_amenities_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('ht_features_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('ht_foods_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('ht_food_types_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('ht_places_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('ht_room_categories_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('ht_services_translations', function (Blueprint $table): void {
            $table->string('lang_code');
