...
use Guestcms\Hotel\Http\Requests\AvatarRequest;
use Guestcms\Hotel\Http\Requests\EditAccountRequest;
use Guestcms\Hotel\Http\Requests\UpdatePasswordRequest;
