...
class AmenityTable extends TableAbstract
{
    public function setup(): void
    {
        $this
            ->model(Amenity::class)
            ->addActions([
                EditAction::make()->route('amenity.edit'),
                DeleteAction::make()->route('amenity.destroy'),
            ]);
    }
    ...
    public function columns(): array
    {
        return [
            IdColumn::make(),
            NameColumn::make()->route('amenity.edit'),
    ...
    {
        return [
            DeleteBulkAction::make()->permission('amenity.destroy'),
        ];
    }
