    ...
    <x-core::card>
        <x-core::card.header>
            <ul class="nav nav-tabs card-header-tabs">
                ...
                {!! apply_filters(BASE_FILTER_REGISTER_CONTENT_TABS, null, new Guestcms\Language\Models\Language()) !!}
            </ul>
        </x-core::card.header>
        <x-core::card.body>
            <div class="tab-content">
                ...
                >
                    <div class="row">
                        <div class="col-md-5">
                            @php
                                do_action(BASE_ACTION_META_BOXES, 'top', new Guestcms\Language\Models\Language());
                            @endphp
                            ...
                            @php
                                do_action(BASE_ACTION_META_BOXES, 'advanced', new Guestcms\Language\Models\Language());
                            @endphp
                        </div>
                        <div class="col-md-7">
