...
namespace Guestcms\Payment\Providers;
...
use Guestcms\Payment\Repositories\Eloquent\PaymentRepository;
use Guestcms\Payment\Repositories\Interfaces\PaymentInterface;
