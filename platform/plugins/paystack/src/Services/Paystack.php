...
namespace Guestcms\Paystack\Services;

use Guestcms\Paystack\Exceptions\IsNullException;
use Guestcms\Paystack\Exceptions\PaymentVerificationFailedException;
use Exception;
...
class Paystack
{
     ...
     */
    public const VS = 'Verification successful';

    /**
     *  Invalid Transaction reference
     */
    public const ITF = 'Invalid transaction reference';
