...
use Guestcms\Translation\Http\Controllers\ExportOtherTranslationController;
use Guestcms\Translation\Http\Controllers\ExportThemeTranslationController;
use Guestcms\Translation\Http\Controllers\ImportOtherTranslationController;
use Guestcms\Translation\Http\Controllers\ImportThemeTranslationController;
use Illuminate\Support\Facades\Route;

Route::group(['namespace' => 'Guestcms\Translation\Http\Controllers'], function (): void {
