...
use Guestcms\Translation\Exceptions\LargeTextException;
use Guestcms\Translation\Exceptions\RateLimitException;
use Guestcms\Translation\Exceptions\TranslationDecodingException;
use Guestcms\Translation\Exceptions\TranslationRequestException;
use Guestcms\Translation\Tokens\GoogleTokenGenerator;
use Guestcms\Translation\Tokens\TokenProviderInterface;
...
class GoogleTranslate
{
    ...
    public function getResponse(string $string): array|string
    {
