            ...
            <div>
                ...
                <form action="{{ route('customer.ajax.review.store', $model->slug) }}" method="post" class="space-y-3 review-form">
                    ...
                    <div class="form-group">
                        <select name="star" id="select-star" style="display: none" class="ignore-nice-select">
                    ...
                    <div class="form-group">
                        <textarea name="content" id="content" class="form-control custom-review-input mb-20" placeholder="{{ __('Enter your message') }}" @disabled(! $canReview)>{{ old('content') }}</textarea>
                    </div>
