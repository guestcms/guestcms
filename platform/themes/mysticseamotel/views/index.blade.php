    ...
    <div style="margin: 40px 0;">
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="border: 1px solid rgba(0,0,0,.1); padding: 10px; margin-top: 10px;direction: ltr;">
                ...
                <div>[hotel-about title="since 1994" subtitle="In the heart of Myrtle Beach." block_icon_1="flaticon-coffee" block_text_1="Breakfast" block_link_1="#" block_icon_2="flaticon-air-freight" block_text_2="Airport Pickup" block_link_2="#" block_icon_3="flaticon-marker" block_text_3="City Guide" block_link_3="#" block_icon_4="flaticon-barbecue" block_text_4="BBQ Party" block_link_4="#" block_icon_5="flaticon-hotel" block_text_5="Luxury Room" block_link_5="#"][/hotel-about]</div>
                <div>[room-categories title="Room Type" subtitle="Inspired Loding" background_image="general/bg.jpg"][/room-categories]</div>
                <div>[hotel-featured-features title="Mystic Sea Motel" subtitle="Mystic Sea Motel has everything for your trip & every single things." button_text="Take a tour" button_url="/rooms"][/hotel-featured-features]</div>
                <div>[rooms][/rooms]</div>
                <div>[video-introduction title="Take a tour" subtitle="Discover Our Motel." content="Watch Video" background_image="general/video-background-02.jpg" video_image="general/video-banner-01.jpg" video_url="https://www.youtube.com/watch?v=EEJFMdfraVY" button_text="Book Now" button_url="/rooms"][/video-introduction]</div>
